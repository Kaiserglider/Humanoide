...
void derecha () {
    ...
    int startAngles02[] = {posiciones[2], posiciones[5], posiciones[0], posiciones[6]};
    int endAngles02[] = { 143, 90, 35, 90};
    smoothMove(4, servos02, startAngles02, endAngles02, t01);

    int servos03[] = { 1, 0, 6};
    int startAngles03[] = {posiciones[1], posiciones[0], posiciones[6]};
    int endAngles03[] = { 45, 50, 70};
    smoothMove(3, servos03, startAngles03, endAngles03, t01);

    int servos04[] = { 2, 0, 3, 6};
    int startAngles04[] = {posiciones[2], posiciones[0], posiciones[3], posiciones[6]};
    int endAngles04[] = { 133, 50, 165, 50};
    smoothMove(4, servos04, startAngles04, endAngles04, t02);

    int servos05[] =      {2, 0, 1, 5, 3, 7, 6};
    int startAngles05[] = {posiciones[2], posiciones[0], posiciones[1], posiciones[5], posiciones[3], posiciones[7], posiciones[6]};
